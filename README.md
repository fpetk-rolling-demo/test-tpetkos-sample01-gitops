...
This repository contains the GitOps deployment manifests for **test-tpetkos-sample01**. These Kubernetes manifests define all the resources needed to deploy the application to your OpenShift/Kubernetes cluster via ArgoCD.
...
| 📂 **components/test-tpetkos-sample01/** | Kustomize base and overlays for all Kubernetes resources |
...
```
components/test-tpetkos-sample01/
...
|----------|------|-------------|
| 🖥️ **Deployment** | `test-tpetkos-sample01` | Streamlit UI application |
| 🦙 **Deployment** | `test-tpetkos-sample01-llama-stack` | Llama Stack inference server |
| 🦙 **Deployment** | `test-tpetkos-sample01-ollama` | Ollama for safety/guardrails |
| ☸️ **Deployment** | `test-tpetkos-sample01-mcp-server` | Kubernetes MCP Server |
| 🌐 **Services** | Various | Internal service networking |
| 🔀 **Route** | `test-tpetkos-sample01` | External access to Streamlit UI |
| 🔐 **RBAC** | `test-tpetkos-sample01-mcp-*` | Permissions for cluster introspection |
| 💾 **PVC** | `test-tpetkos-sample01-ollama-data` | Persistent storage for Ollama models |
...
| Resource | Link |
|----------|------|
| 📝 **Source Repository** | [https://github.com/fpetk-rolling-demo/test-tpetkos-sample01](https://github.com/fpetk-rolling-demo/test-tpetkos-sample01) |
